Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/Newspad/RMStore'
  s.author = 'Hermes Pique'
  s.social_media_url = 'https://twitter.com/NewspadEN'
  s.source = { :git => 'https://github.com/Newspad/RMStore.git', :tag => "v#{s.version}" }
  s.platform = :ios, '7.0'
  ...
  s.subspec 'AppReceiptVerifier' do |arv|
    ...
    arv.dependency = 'OpenSSL-Universal', :podspec => 'OpenSSL-Universal.podspec'
  end
